...
class setup_surface_group():
	...
	def __init__(self):
		...
		mc_albedo_type = option(
			...
			gui_inputs=(FileInput(name='Input.rte.mc.filename[FN_MC_ALBEDOTYPE]'),),
			tokens=addToken( name='Input.rte.mc.filename[FN_MC_ALBEDOTYPE]',datatype=file ),	
			parents=['uvspec'], 
			non_parents=brdf_non_parents,
		...
		mc_rpv_type = option(
			...
			gui_inputs=(FileInput(name='Input.rte.mc.filename[FN_MC_RPVTYPE]'),),
			tokens=addToken( name='Input.rte.mc.filename[FN_MC_RPVTYPE]',datatype=file ),	
			parents=['uvspec'], 
			non_parents=brdf_non_parents,
