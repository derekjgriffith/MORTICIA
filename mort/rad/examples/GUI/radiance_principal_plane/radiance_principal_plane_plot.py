...
inp_fname = "./radiance_principal_plane.INP"
umu, phi = read_inp(inp_fname).items()
umu_txt, umus = umu

out_fname = "./radiance_principal_plane.OUT"
...
plt.ylabel(r"Normalized radiance $\pi$L/(E$_0 \cos\theta_{sun}$)", fontsize = 12)
plt.xlabel(r"Viewing zenith angle $\theta$ (degree)", fontsize = 12)
